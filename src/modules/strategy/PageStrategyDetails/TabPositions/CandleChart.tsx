...
function splitData(rawData: Array<Array<number | string>>) {
  const categoryData = [];
  const values = [];
  for (const rawDatum of rawData) {
    categoryData.push(rawDatum.splice(0, 1)[0]);
    values.push(rawDatum);
  }
  return {
    categoryData,
    values,
  ...
  series: [
    {
      ...
      markPoint: {
        ...
        data: [
          marker(['2013/5/31', 2320], -1),
          marker(['2013/5/17', 2250], 1),
          marker(['2013/5/6', 2212], 1),
          marker(['2013/4/19', 2245], -1),
        ],
      },
      markLine: {
        symbol: ['none', 'arrow'],
...
function marker(coord: [string, number], dir: 1 | -1) {
  return {
    name: 'Mark',
    coord,
    value: coord[1],
