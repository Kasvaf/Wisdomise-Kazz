...
export { ReactComponent as IconTrades } from 'modules/base/Layout/useMenuItems/icons/positions.svg';
export { ReactComponent as IconQuests } from 'modules/base/Layout/useMenuItems/icons/quests.svg';
