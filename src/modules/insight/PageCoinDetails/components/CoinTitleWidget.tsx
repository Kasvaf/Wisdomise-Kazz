...
export const CoinTitleWidget: FC<{
  ...
  const coin = useCoinDetails({ slug, suspense: true });
  const nCoin = useNCoinDetails({ slug, suspense: true });
  ...
  return (
    <>
      <div
        className={clsx(
          'flex items-center justify-between gap-1 overflow-auto whitespace-nowrap mobile:flex-col',
          className,
        )}
      >
