...
## “Wisdomise Passive Income” Service Providing Agreement

This “Wisdomise Passive Income” Service Providing Agreement (hereinafter “**Wisdomise Passive Income Agreement**”) contains provisions governing together with the Terms and Conditions and the Cryptocurrency Risk Disclosure the contractual relationship between Service Provider and the Client if the Client uses the product “**Wisdomise Passive Income**”.

### 1. Subject

1. The Client mandates the Service Provider to use his tools and functionalities that allow the Client to manage the cryptocurrencies deposited in the Client's existing wallet or in a new wallet to be created with a third-party crypto exchange platform (hereinafter the "**Portfolio**"). The Service Provider performs the services under this Wisdomise Passive Income Agreement by means of artificial intelligence (“**AI**”) and, in principle, without human intervention (hereinafter the “**Wisdomise Passive Income Services**” or “**Wisdomise Passive Income**”). Furthermore, the software helps to allocate the cryptocurrencies held in the wallet with a third party crypto exchange platform across a portfolio of crypto coins and track the cryptocurrencies over time. For the use of the Wisdomise Passive Income Services, the Service Provider offers to open an account (hereinafter the “**Account**”).

2. If the Client selects the option to create a new wallet during the Account opening process, the Client agrees that the wallet will be opened with a third party crypto exchange provider. The Client agrees that the new wallet is not provided by the Service Provider, but by a third party.

3. Based on the information provided by the Client when opening an Account, the Service Provider creates a risk profile (“**Client’s Risk Profile**”). The Client’s Risk Profile is taken into account in the provision of the Wisdomise Passive Income Services under this Wisdomise Passive Income Agreement.

4. Before offering the Wisdomise Passive Income Services, the Service Provider has carried out all usual initial checks and self-checks regarding the AI (including but not limited to regression testing, unit tests, integration tests, stress tests and user acceptance tests).

5. The Service Provider monitors the correct functioning of the AI on a regular basis by means of a monitoring dashboard.
...
1. In order to perform the Wisdomise Passive Income Services, the Service Provider is authorized to act in the name of, for the account of and at the risk of the Client at the Service Provider’s own discretion within the framework of the provisions set out in this Wisdomise Passive Income Agreement, including any future amendments. Additionally, the Service Provider is authorized to act in its own name and for the account of and at the risk of the Client at the Service Provider’s own discretion within the framework of the provisions set out in this Wisdomise Passive Income Agreement, including any future amendments.

2. In particular, but not exclusively, the Service Provider is authorized to make and execute, in the name of, for the account of and at the risk of the Client, as well as in its own name, but for the account of and at the risk of the Client, purchase and/or sell decisions regarding the Client’s Portfolio.

### 3. Investment objective and other information provided by the Client

1. The Client confirms that the information provided when opening his Account, in particular with regard to the creation of the Client’s Risk Profile, is correct at the date of the first use of the Wisdomise Passive Income Services. This includes, in particular, the Client's knowledge and investment experience, the Client’s trading patterns and the Client's risk appetite.

2. In addition, the Client confirms and acknowledges that, under normal circumstances, he does not need any cryptocurrencies deposited in the Portfolio to support himself and/or his dependents.

3. The Client undertakes to notify the Service Provider immediately of any changes to the information provided by him via his Account. The changes communicated by the Client via his Account shall replace, for the purposes of this Wisdomise Passive Income Agreement, the information previously provided by the Client.

### 4. Investment Strategy Parameters
...
4. The Service Provider only provides Wisdomise Passive Income Services regarding the cryptocurrencies mentioned in Annex I (hereinafter the “**Cryptocurrencies**”) including any future amendments.

5. The Service Provider reserves the right to, but is not obliged to, extend the Wisdomise Passive Income Services to other cryptocurrencies. In the event that the Service Provider extends its Wisdomise Passive Income Services to other cryptocurrencies, it shall amend Annex I accordingly. The Service Provider shall inform the Client of amendments to Annex I by email and by publishing the information on its website.

6. The AI changes the composition of the Portfolio at regular intervals in line with market developments ("**Reallocations**"). The AI takes into account various circumstances (e.g. frequent intervals, market events) when performing Reallocations. Which circumstances are taken into account and how frequently Reallocations are made depends on the Client’s Risk Profile. A Reallocation will also be made if the maximum risk level determined by the Client is reached or exceeded. The more frequent Reallocations are made, the better the Client's investment objective can be pursued. However, as Reallocations may incur transaction costs, frequent Reallocations may increase the costs borne by the Client. The Reallocation frequency does not determine the exact time of the next Reallocation. In particular, for technical reasons or to protect the interests of its Clients, the AI may carry out the Reallocation a few days earlier or later than the date determined by the Reallocation frequency.

### 5. Instructions and Preferences of the Client

1. The Client may communicate preferences to the Service Provider regarding the execution of the Wisdomise Passive Income Services under this Wisdomise Passive Income Agreement. During the provision of the Wisdomise Passive Income Services, the Client may only change these preferences by changing the Client’s Risk Profile. However, the change in the Client’s Risk Profile shall have no effect on the execution of decisions already taken at the time of the receipt of the change notice by the Service Provider.

### 6. Communication channel

1. The Client may communicate with the Service Provider only via his Account (all other communication channels are excluded) for the execution of this Wisdomise Passive Income Agreement.
...
3. The Service Provider shall ensure that the Client’s Portfolio is diversified in accordance with the Client's Risk Profile.

4. The Service Provider does not take into account, even at the Client's request, any tax implications that the Wisdomise Passive Income Services provided under this Wisdomise Passive Income Agreement may have on the Client's situation.

### 8. Special risks of these Wisdomise Passive Income Services

1. The Client agrees to take note of the User Guide and the GitHub documentation available in the Client's Account and on the Service Provider’s website.

2. The Client confirms that he is aware of the risks associated with the purchase, sale and holding of Cryptocurrencies. Additionally, the Client confirms that he has received and taken note of the Cryptocurrency Risk Disclosure.

3. The Client confirms to understand and acknowledges that the Portfolio may suffer a significant loss in value up to and including a total loss of the amount deposited in the Portfolio even if the Service Provider is not at fault.

4. If the Client selects to create a new wallet, the Client agrees to bear all risks associated with the wallet being held with a third party, such as, but not limited to, bankruptcy of the third party, unauthorized access to the wallet held with the third party due to a hacker attack or similar event. The Service Provider shall not be liable for any direct or indirect damages arising in connection with the holding of the wallet with a third party, unless such damage is due to Service Provider’s gross negligence or willful misconduct.

5. The Client confirms that he is fully informed of and understands the specific risks associated with the Client’s investment objective and strategy and is aware of its possible consequences. The Client confirms and accepts in particular that the Wisdomise Passive Income Services are, in principle, performed automatically and without human intervention.

6. The Client confirms that he understands and accepts that the Service Provider is not involved in the execution of trades, but the trades are executed by the third party crypto exchange platform with which the Client holds his wallet. The Client confirms that he understands and accepts that there are risks associated with this third party crypto exchange platform which the Service Provider cannot foresee and cannot influence.

7. Furthermore, the Client confirms that he understands and accepts the specific risks associated with the AI. These are described in Sections ‎4, ‎5, ‎7, and ‎8 and relate in particular to the limited investment universe, the frequency of portfolio reallocation, the frequency of risk level control and the specific criteria for portfolio diversification.

8. The Client confirms that he understands and accepts the technical risks of an automated management of sales and purchases of Cryptocurrencies, for example those related to a system error and/or connection difficulties. He also understands and accepts that the AI is based on sources that are considered reputable, but that it cannot be guaranteed that the information used by the AI is accurate, complete and up-to-date, and that this may have an impact on the management of the Client’s Portfolio.

### 9. Fees

1. If so agreed between the Service Provider and the Client during the Account opening process, the Service Provider shall receive fees for its Wisdomise Passive Income Services. The amount of the fees shall be based on a pricing model which the Client confirms when opening an Account.

2. If the Client and the Service Provider have not entered into an agreement within the meaning of clause ‎9.1, the Service Provider shall not receive fees.

3. The Client acknowledges and accepts that he has to bear and pay all fees, commissions and costs incurred for the execution of trades on a third party crypto exchange platform under this Wisdomise Passive Income Agreement.

### 10. Account statements

1. The Wisdomise Passive Income Services carried out under this Wisdomise Passive Income Agreement may be viewed by the Client at any time on the Client’s Account. The Service Provider is not obliged to send account statements to the Client by any other means.

### 11. Exclusion of liability and limitation of due diligence obligations

1. The Service Provider will perform its contractual and legal obligations towards the Clients with ordinary business diligence.

2. The Service Provider does not make any undertaking to achieve a particular performance. The Client understands and accepts that past performance is no guarantee of future performance. The Service Provider accepts no liability whatsoever for the outcome of the management of the Portfolio carried out by the AI or for any losses that may result for the Client, unless the Service Provider acts with gross negligence or willful misconduct.

3. The Service Provider shall only be liable to the Client for direct losses caused by fraudulent or grossly negligent breaches of the Service Provider’s obligations under applicable Swiss law or the Wisdomise Passive Income Agreement. In particular, but not limited to, the Service Provider shall not be liable for:

4. Damages arising from the access to and use, or any hindrance to the access and use, of the Service Provider’s website, the Client’s Account and the use of the information and Wisdomise Passive Income Services available thereon;

5. Damages arising from the Service Provider’s lawful intervention pursuant to legal requirements and/or the Wisdomise Passive Income Agreement;

6. Damages arising in connection with the holding of the wallet with a third party exchange;

7. Damages arising from events as described in Articles 9.11 to 9.14 of the Terms and Conditions or any other materialization of any risks associated with Internet;
...
10. Subject to the provisions of Section ‎11.1 to ‎11.4 and if the Service Provider has failed to apply due business diligence, its liability for any Damages suffered by the Client shall in any case be limited to an amount equal to the loss of interest by the Client.

### 12. Miscellaneous

1. The Client undertakes to read the notices provided by the Service Provider in the Client’s Account at regular short intervals.

2. This Wisdomise Passive Income Agreement may be amended or supplemented by a written agreement between the Service Provider and the Client. The Service Provider allows the Client to change its investment objective online, as well as the other information provided by the Client when opening its Account with the Service Provider.

3. This Wisdomise Passive Income Agreement supplements the existing agreements between the Client and the Service Provider, in particular the Service Provider's Terms and Conditions, which also apply to this Wisdomise Passive Income Agreement. If the provisions of this Wisdomise Passive Income Agreement and the provisions of other agreements concluded between the Client and the Service Provider conflict, the provisions of this Wisdomise Passive Income Agreement shall prevail.

### 13. Term and Termination, Transaction Thresholds

1. This Wisdomise Passive Income Agreement is valid for 90 days from the date of signing ("**Limited** **Term**”). During the Limited Term, the Service Provider may perform the Wisdomise Passive Income Services, provided the total value of such transactions performed in connection with the Wisdomise Passive Income Services does not exceed CHF 1,000.00 ("**Basic Membership**”). However, the valuation of the assets accessible with the Client’s wallet during the Limited Term may exceed CHF 1,000.00. Upon the expiry of the Limited Term, this Wisdomise Passive Income Agreement shall terminate without further actions required. Sections 13.4 Sent. 2, 3 and 13.5 shall apply mutatis mutandis.

2. The Limited Term may be extended to an unlimited term ("**Unlimited Term**”), subject to the Client’s successful identification by video interview ("**Identity** **Verification**”). The Identity Verification may be completed at any time during the Limited Term. After completion of the Identity Verification, this Wisdomise Passive Income Agreement shall extend its validity indefinitely and remain effective until terminated. For the avoidance of doubt, the termination upon expiry of the Limited Term (Section 13.1 Sent. 4) shall not apply.

3. Upon the establishment of the Unlimited Term of this Wisdomise Passive Income Agreement, the transaction threshold of the Basic Membership (Section 13.1 Sent. 2) shall not apply (“**VIP Membership**”).

4. This Wisdomise Passive Income Agreement may be terminated at any time by the parties involved. As soon as the Service Provider has received the termination of this Wisdomise Passive Income Agreement by the Client, it will no longer carry out the Wisdomise Passive Income Services. However, the termination of this Wisdomise Passive Income Agreement shall have no effect on the execution of decisions already taken at the time of the receipt of the termination notice by the Service Provider.

5. Termination of this Wisdomise Passive Income Agreement shall not affect any other agreement between the Client and the Service Provider. This Wisdomise Passive Income Agreement shall not terminate in the event of the Client's death, incapacity or disappearance, insolvency or bankruptcy.

### 14. Applicable law and place of jurisdiction

1. This Wisdomise Passive Income Agreement is governed by Swiss law.

2. The place of performance and enforcement for Clients domiciled abroad and the exclusive place of jurisdiction for all legal disputes in connection with this Wisdomise Passive Income Agreement shall be Zug, Switzerland. The Service Provider shall, however, also be entitled to assert its rights in court at the Client's place of domicile or in any other competent authority. In this case Swiss law shall also be applicable.

The Client confirms that he has read and understood and accepts all the provisions of this Wisdomise Passive Income Agreement.
...
This “Wisdomise Insight” Service Providing Agreement (hereinafter “**Wisdomise Insight Agreement**”) contains provisions governing together with the Terms and Conditions and the Cryptocurrency Risk Disclosure the contractual relationship between Service Provider and the Client if the Client uses the product “**Wisdomise Insight**”.

### 1. Subject

1. The Service Provider offers an artificial intelligence (“**AI**”) based tool that answers the Client’s questions about crypto assets. The answers provided by the AI are general information about crypto assets aimed at the general public, including analysis of the performance of crypto assets ( “**Wisdomise Insight** **Services**”)

2. When providing the Wisdomise Insight Services, the Service Provider does not take into account the Client’s financial, personal and / or professional circumstances nor the Client’s investment experience, investment objectives, investment strategy, investment horizon, risk behavior or other individual parameters. The information provided by the Service Provider in connection with the Wisdomise Insight Services is general information aimed at the general public. It does not constitute an offer or invitation to invest in crypto assets The Service Provider does not offer investment advice or other investment services.

### 2. Usage Requirements

1. The Client must be at least 18 years old to use the Wisdomise Insight Services. The Client may not make his access credentials or account available to others, and the Client is responsible for all activities that occur using his credentials.

2. The Service Provider grants the Client a non-exclusive right to use the Wisdomise Insight Services, limited to the term of this Wisdomise Insight Agreement and non-transferable to third parties, within the framework of the provisions set out in this Wisdomise Insight Agreement. The Client agrees to comply with the provisions set out in this Agreement and all applicable laws when using Wisdomise Insight Services.

3. For the avoidance of doubt, the Service Provider owns all rights, title, and interest in and to Wisdomise Insight Services. The Service Provider does not transfer any rights, title or interest to Wisdomise Insight Services to the Client.

4. The Client may not (i) use Wisdomise Insight Services in a way that infringes, misappropriates or violates any person’s rights; (ii) reverse assemble, reverse compile, decompile, translate or otherwise attempt to discover the source code or underlying components of models, algorithms, and systems of the Wisdomise Insight Services; (iii) use outcome from the Wisdomise Insight Services to develop models that compete with Wisdomise Insight Services; or (iv) represent that outcome from the Wisdomise Insight Services was human-generated when it is not. The Client agrees to comply with any rate limits and other requirements in this Wisdomise Insight Agreement. The Client agrees to use Wisdomise Insight Services only in geographies currently supported by the Service Provider.

5. The Service Provider appreciates feedback, comments, ideas, proposals and suggestions for improvements. If the Client provides any of these things, the Service Provider may use it without restriction or compensation to the Client.

6. Any third-party software, services or other products the Client uses in connection with the Wisdomise Insight Services are subject to the third party’s terms. The Service Provider has no control over such third-party products and is not liable for third-party products.

### 3. Content

1. For the use of Wisdomise Insight Services the Client submits requests, including data, to the Service Provider by using the Wisdomise Insight Services (“**Request**”). The Client will receive the outcome generated and returned by the Wisdomise Insight Services based on the Request (“**Outcome**”, Request and Outcome collectively the “**Content**”).

2. The Service Provider and the Client agree that, to the extent permitted by applicable law, the Client owns all rights, title and interest to the Request and the Outcome. The Client undertakes to name Wisdomise Insight as the source of the Outcome if he uses the Outcome for private and or commercial purposes. The Client grants the Service Provider a transferable right to use the Request and Outcome not limited in object, time or place. This means that the Service Provider may use the Request and/or Outcome, in particular, but not limited to, commercial purposes and to provide and maintain the Wisdomise Insight Services, comply with applicable law, and enforce its policies.

3. Due to the nature of machine learning, Outcome may not be unique and the Wisdomise Insight Services may generate the same or similar outcome for other users.

4. The Service Provider may use the Content to help develop and improve Wisdomise Insight Services. To object to the use of the Client’s Content for the improvement of Wisdomise Insight Services, the Client may send an email to eye@wisdomise.io. The Client confirms that he understands that in some cases this may limit the ability of Wisdomise Insight Services to better address the Client’s specific use case.

5. Artificial intelligence and machine learning are rapidly evolving fields of study. The Service Provider is constantly working to improve Wisdomise Insight Services to make them more accurate, reliable, safe and beneficial. Given the probabilistic nature of machine learning, use of Wisdomise Insight Services may in some situations result in incorrect Outcomes that do not accurately reflect real facts. The Client should evaluate the accuracy of any Outcome as appropriate for his use case, including by using human review of the Outcome.

### 4. Fees and Payments

1. The Client may use Wisdomise Insight free of charge for 30 days, but not more than five Requests within these 30 days(“**Free Trial**”). From the sixth Request on, the Service Provider will charge the Client the prices and fees on the applicable pricing page. The Client may not create more than one account to benefit from credits provided in Free Trial. If the Service Provider has reasons to believe that the Client is not using the Free Trial in good faith, the Service Provider may stop providing access to Wisdomise Insight Services.

2. The Client undertakes to pay all fees charged to his account (“**Fees**”) according to the prices and terms on the applicable pricing page, or as otherwise agreed between the Client and the Service Provider in writing. The Service Provider reserves the right to correct pricing errors or mistakes even if the Service Provider has already issued an invoice or received payment. The Client undertakes to provide complete and accurate billing information including a valid and authorized payment method. The Service Provider will charge your payment method on a monthly basis but may reasonably change the date on which the charge is posted. Payments are non-refundable except as provided in this Agreement.

3. Unless otherwise stated, Fees do not include federal, state, local, and foreign taxes, duties, and other similar assessments (“**Taxes**”). The Client is responsible to pay all Taxes associated with the use of the Wisdomise Insight Services, excluding Taxes based on the Service Provider’s net income, and the Service Provider may invoice the Client for such Taxes. The Client undertakes to timely pay such Taxes and provide the Service Provider with documentation showing the payment, or additional evidence that the Service Provider may reasonably require. The Service Provider uses the name and address in the Client’s Account registration as the place of supply for tax purposes. The Client undertakes to keep this information accurate and up-to-date.
...
If the Client uses the Wisdomise Insight Services to process personal data, the Client must provide legally adequate privacy notices and obtain necessary consents for the processing of such data. The Client represents to the Service Provider that he processes such data in accordance with applicable law.

### 6. Term and Termination

1. This Wisdomise Insight Agreement is valid from the date of the signing and remains in effect until terminated. Either party may terminate this Wisdomise Insight Agreement at any time without notice. Notice of termination must be in writing. The Client may terminate this Wisdomise Insight Agreement by sending an email to eye@wisdomise.io The Service Provider may terminate this Wisdomise Insight Agreement by posting the notice of termination in the Client’s’ Account or by sending the termination notice to the email address specified by the Client in his Account. The Service Provider may suspend the Client’s access to Wisdomise Insight Services if the Client does not comply with this Agreement, if the Client poses a security risk to the Service Provider or any third party.

2. Upon termination, the Client will stop using Wisdomise Insight Services immediately.

### 7. Indemnification, Limitations on Liability

1. The Client will defend, indemnify, and hold harmless the Service Provider, its affiliates, and its personnel, from and against any claims, losses, and expenses (including attorneys’ fees) arising from or relating to the Client’s use of Wisdomise Insight Services, including the Content, and the Client’s breach of this Wisdomise Insight Agreement or violation of applicable law.
...
5. Subject to the provisions of Section 7.1 to 7.4 and if Service Provider has failed to apply due business diligence, its liability for any damages suffered by the Client shall in any case be limited to an amount equal to the loss of interest by the Client.

### 8. General Terms

1. This Wisdomise Insight Agreement does not create a partnership, joint venture or agency relationship between the Client and the Service Provider or any of the Service Provider’s affiliates. The Service Provider and the Client are independent contractors and neither party will have the power to bind the other or to incur obligations on the other’s behalf without the other party’s prior written consent.

2. The Client may not use the Service Provider’s or any of its affiliates’ names, logos, or trademarks, without our prior written consent.

3. The Client may not assign or delegate any rights or obligations under this Wisdomise Insight Agreement, including in connection with a change of control. Any purported assignment and delegation shall be null and void. The Service Provider may assign any rights or obligations under this Wisdomise Insight Agreement in connection with a merger, acquisition or sale of all or substantially all of our assets, or to any affiliate or as part of a corporate reorganization.

4. The Service Provider may amend this Wisdomise Insight Agreement from time to time by posting a revised version on the website, or if an update materially adversely affects the Client’s rights or obligations under this Wisdomise Insight Agreement the Service Provider will provide notice to the Client either by emailing the email associated with your account or providing an notification in the Account.

5. All notices will be in writing. The Service Provider may notify the Client using the registration information the Client has provided or the email address associated with the use of the Wisdomise Insight Services. Service will be deemed given on the date of receipt if delivered by email or on the date sent via courier if delivered by post. Service Provider accepts service of process at the following address: Wisdomise (Switzerland) AG, Neuhofstrasse 5A, CH- 6340 Baar.

6. No failure or delay by either party to exercise any right or remedy provided under this Wisdomise Insight Agreement or by law shall operate as a waiver of it or any other right or remedy, nor shall it prevent or restrict the further exercise of it or any other right or remedy. No single or partial exercise of any right or remedy shall preclude or restrict any other or further exercise of it, or any other right or remedy. If all or any part of any provision hereof is held invalid or unenforceable for any reason, all other provisions hereof shall remain valid and binding.

7. This Agreement and any documents incorporated in this Agreement contain the entire agreement between the Client and the Service Provider regarding the use of the Wisdomise Insight Services. This Wisdomise Insight Agreement contains the whole agreement between the parties relating to the subject matter of this Wisdomise Insight Agreement and supersedes any previous written or oral agreement between the parties in relation to such matters.

8. This Wisdomise Insight Agreement will be governed exclusively by and construed in accordance with substantive Swiss law. All claims arising out of or relating to this Wisdomise Insight Terms will be brought exclusively in the courts of Zug, Switzerland. However, the Service Provider reserves the right to bring such proceedings before the competent courts having jurisdiction at the Client’s place of residence or domicile or before any other competent court, in which case substantive Swiss law shall remain exclusively applicable.

## TERMS AND CONDITIONS FOR SERVICE PROVIDING AGREEMENTS OF WISDOMISE (ESTONIA) OÜ

**dated as of 7 March 2024**

These Terms and Conditions (hereinafter the “**Terms and Conditions**”) contain important provisions governing the contractual relationship between the client (hereinafter the “**Client**”) and Wisdomise (Estonia) OÜ, Pärnu mnt 139e/2-8, 11317 Tallinn, Estonia (hereinafter the “**Service Provider**” or “**Wisdomise**”). For ease of reading, the masculine form refers to any gender.

### 1. BASIS OF BUSINESS RELATIONSHIP

1. These Terms and Conditions, together with the Wisdomise Passive Income Agreement, the Wisdomise Insight Agreement, and any document referred to by these documents, if any, and any document amending them and/or expressed to be supplemental thereto shall hereinafter collectively be referred to as the “**Agreement**” and shall collectively serve to regulate the business relationship between the Service Provider and the Client.
...
1. The Service Provider may offer various services to the Client (hereinafter the “**Services**”) the terms of which will be defined in these Terms and Conditions, the Wisdomise Passive Income Agreement and the Wisdomise Insight Agreement. The Service Provider may, at its sole discretion, decide not to provide certain Services, or to allow only limited access, to certain Clients or Client groups.

2. The Service Provider may offer, in particular, the use of a software that manages the purchase and sale of certain cryptocurrencies as defined in the Wisdomise Passive Income Agreement (“**Software**”) held by the Client in a wallet with a third party crypto exchange platform (“**Portfolio**”). Furthermore, the Software helps to allocate the cryptocurrencies held in the wallet with a third party crypto exchange platform across a portfolio of crypto coins and track the cryptocurrencies over time. Additionally, the Service Provider offers an artificial intelligence based tool, that is trained to answer the Client’s crypto related questions (“**Wisdomise Insight**”). In addition, the Service Provider offers the opening of an account that displays the executed purchase and/or sale decisions made by the Software and their performance and gives access to Wisdomise Insight (“**Account**”).
...
### 5. PROVISION OF CROSS-BORDER SERVICES (LOCAL RESTRICTIONS)
...
4. If the Client is not an individual, it shall inform the Service Provider immediately of any changes to its “non-US person” status.
...
_Notices from the Service Provider_
...
15. Any Damages resulting from the use of email services or any other means of communication, such as delays, misunderstandings, transmission or other errors, data losses, repetition, technical faults, overloads, (system) breakdowns or interruptions, malfunctions, interference, etc. shall be borne by the Client.

### 10. CONFIRMATIONS, STATEMENTS AND COMPLAINTS

1. The Client shall immediately verify the contents of all statements, confirmations, reports and other similar documents (hereinafter the “**Reports**”) made available on his Account. Any complaint by the Client (e.g. and any objections concerning a Report or a Notice from the Service Provider) must be made by email sent to the email address hello@wisdomise.io immediately upon receiving the corresponding Report or Notice, but not later than thirty days after receipt. After this period the Report or Notice concerned shall be deemed to have been approved. The Client shall bear the consequences of any delay in making the complaint.
...
4. Subject to the provisions of Section ‎11.1 to ‎11.3 and if the Service Provider has failed to apply due business diligence, its liability for any Damages suffered by the Client shall in any case be limited to an amount equal to the loss of interest by the Client.
...
### 13. FEES AND CHARGES TO THE CLIENT
...
2. The Client consents and explicitly authorizes that the Service Provider exchanges information on the Client (including personal data) with parent companies and subsidiaries of the Service Provider, as well as with third party intermediaries and service providers abroad, including in jurisdictions that do not offer a level of protection of personal data equivalent to that ofEstonia. This consent and authorization shall also be considered to have been given to the relevant parent company, subsidiary of the Service Provider, third party intermediary or service provider which shall also be authorized to process such information on the client, in accordance with applicable laws.

3. The Client acknowledges and agrees that once Personal Data has been transferred outside of Estonia, it is generally no longer protected by Estonian law but subject to the applicable legislation and may be transmitted to third parties or authorities in accordance with any applicable law.

4. The Client is aware of the fact that any data transmitted via the Internet are regularly transmitted in an unsupervised manner beyond Estonia, even if the sender and the recipient are both located in Estonia. Even where the data themselves are encrypted, the sender and recipient can sometimes remain unencrypted, such that third parties may be able to infer their identity.

5. The Client also acknowledges that the Service Provider may use a third party supplier’s software and that the IP address of the computer or device on which the Client uses the said software may become known to that third party supplier, who may not be located in Estonia. The Client accepts any and all related consequences, particularly in terms of confidentiality and data protection.

### 15. MONEY LAUNDERING

1. The Client confirms that he is aware of the requirements imposed by anti-money laundering legislation and regulations and that he is obliged to cooperate fully with the Service Provider in order to comply with all applicable requirements. Any other obligations arising out of and in connection with legal and regulatory anti-money laundering measures under any applicable laws remain reserved.
...
1. For the purpose of outsourcing all or part of its activities, the Service Provider reserves the right to procure services from third parties, including parent companies, subsidiaries of the Service Provider, in Switzerland, Estonia or abroad. Such outsourced activities shall remain under the responsibility and supervision of the Service Provider to the extent required by applicable laws and regulations. Where personal data of the Client is involved, the Service Provider will ensure its confidentiality in accordance with applicable law.
...
2. The Service Provider also reserves the right to transfer the existing Agreement with the Client to wholly owned subsidiaries, including foreign subsidiaries, with the result that the subsidiary shall assume all rights and obligations under the Agreement and the Service Provider shall withdraw from the Agreement. The Client hereby gives its consent in advance to such a transfer of the Agreement. In the event of a transfer of the Agreement, the Client will be notified.

3. Should any provision of the Agreement or any part thereof be illegal, invalid or unenforceable in any manner whatsoever pursuant to the legislation of any given jurisdiction, this shall not affect the legality, validity or enforceability of the remaining provisions of the Agreement and any part thereof, and the Service Provider and the Client shall endeavor to reach an agreement and/or replace the illegal, invalid or unenforceable provision by a legal, valid and enforceable solution that comes as close as possible to the purpose of the affected provision. If a provision of the Agreement or any part thereof becomes illegal, invalid or unenforceable because of a law, Market Rule or other regulation enacted or adopted hereafter, the affected provision shall be deemed modified or superseded, as the case may be, by the applicable provisions of such law, Market Rule or regulation.

4. In the event of the death of the Client, the Service Provider reserves the right to make enquiries and request that the formalities, particularly the certificate of inheritance and the death certificate, be provided to the Service Provider.

5. The Client may not assign any of its rights and obligations pursuant to the Agreement (or any part thereof) without the prior written consent of the Service Provider.

6. Should the Service Provider fail to enforce or exercise or experience a delay in enforcing or exercising any of its rights under the Agreement this shall not be construed as constituting a waiver of such rights, nor shall it compromise any enforcement or exercise of such rights, whether now or in the future.

7. Unless otherwise agreed, any other special regulations or agreements shall take precedence over the Terms and Conditions. Within any of the above-mentioned documents, a specific regulation shall take precedence over a general regulation unless otherwise agreed.

8. The days on which the Service Provider offers its Services shall be referred to as “**Business Days**”. Saturday, Sunday and any public holiday at the seat of the parent company of the Service Provider in Zug in Switzerland shall not be considered as Business Days.

9. Any reference in the Agreement or any part thereof to a person includes individuals and legal entities.

10. Any reference in the Agreement or any part thereof to the Service Provider includes, where relevant, the Service Provider’s directors, managers, officers, employees, successors, agents and other representatives as well as subsidiaries and their directors, managers, officers, employees, successors, agents and other representatives.

11. Any reference in the Agreement or any part thereof to a law, rule, or legal provision includes any subsequent amendment made to it.
...
2. The place of performance, the place of enforcement against Clients residing abroad and the exclusive place of jurisdiction for any dispute arising from or in relation to the Agreement or any part thereof shall be at the seat of the parent company of the Service Provider in Zug in Switzerland. However, the Service Provider reserves the right to bring such proceedings before the competent courts having jurisdiction at the Client’s place of residence or domicile or before any other competent court, in which case substantive Swiss law shall remain exclusively applicable.

## Privacy Policy

PRIVACY POLICY REGARDING OUR DATA PROCESSING UNDER ARTICLES 13, 14 AND 21 GENERAL DATA PROTECTION REGULATION (GDPR)

### 1. Data Controller and contact details

Data Controller:Wisdomise (Estonia) OÜ, Pärnu mnt 139e/2-8, 11317 Tallinn, EstoniaE-Mail support@wisdomise.io
...
The legal basis for data processing is Art. 6 para. 1 p. 1 lit. f GDPR. Our legitimate interest is based on the purposes of data collection listed above. Under no circumstances do we use the data collected for the purpose of drawing inferences concerning your person.

**B) General contact, contact via contact form**
...
Data processing for the purpose of contacting us will be carried out on the basis of your voluntary consent in accordance with Art. 6 (1) Sentence 1 lit. a GDPR. Otherwise, the legal basis for data processing is Art. 6 para. 1 lit. b) GDPR or Art. 6 para. 1 lit. f) GDPR.

**C) Account Information**

When you create an account with us, we will collect information associated with your account, including your name, contact information, account credentials, payment card information, wallet address and transaction history.

This data is used to process the contractual relationship and to process your enquiries. Any further use, in particular the passing on of data to third parties for the purposes of advertising, market or opinion research, does not take place.
...
When you use our Services, we may collect Personal Information resulting from your journey while using our website that you provide to our Services.
...
### 4. Transfer of your data to a third party
...
The effective date of this Privacy Policy is May 2023.
