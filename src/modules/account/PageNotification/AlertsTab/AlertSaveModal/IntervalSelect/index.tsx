      ...
      ? {
          label: (
            <span className="underline underline-offset-4">
              {cooldownMode
                ? t('alerts.invervals.after', {
                    seconds: formattedNumber,
                  })
                : t('alerts.invervals.every', {
                    seconds: formattedNumber,
                  })}
            </span>
          ),
...
const useIntervalOptions = (
  ...
  return useMemo<DefaultOptionType[]>(() => {
    let options: DefaultOptionType[] = cooldownMode
      ? [
          {
            label: `1 ${t('alerts.invervals.min')}`,
            value: 60,
          },
          {
            label: `3 ${t('alerts.invervals.min')}`,
            value: 180,
          },
          {
            label: `10 ${t('alerts.invervals.min')}`,
            value: 600,
          },
          {
            label: `15 ${t('alerts.invervals.min')}`,
            value: 900,
          },
          {
            label: `30 ${t('alerts.invervals.min')}`,
            value: 1800,
          },
          {
            label: `1 ${t('alerts.invervals.hour')}`,
            value: 3600,
          },
          {
            label: `2 ${t('alerts.invervals.hour')}`,
            value: 7200,
          },
          {
            label: `4 ${t('alerts.invervals.hour')}`,
            value: 14_400,
          },
          {
            label: `6 ${t('alerts.invervals.hour')}`,
            value: 21_600,
          },
          {
            label: `12 ${t('alerts.invervals.hour')}`,
            value: 43_200,
          },
          {
            label: `24 ${t('alerts.invervals.hour')}`,
            value: 86_400,
          },
        ]
      : [
          {
            label: t('alerts.invervals.hourly'),
            value: 3600,
          },
          {
            label: t('alerts.invervals.daily'),
            value: 86_400,
          },
          {
            label: t('alerts.invervals.weekly'),
            value: 604_800,
          },
          {
            label: t('alerts.invervals.monthly'),
            value: 2_592_000,
          },
        ];
