  ...
  return (
    ...
    >
      <div className="mb-2 overflow-hidden rounded-2xl bg-v1-surface-l1 p-3">
        ...
        <div
          className="flex w-[35rem] flex-col items-end overflow-hidden rounded-xl bg-v1-surface-l2 max-md:origin-left max-md:scale-[calc(80vw/35rem)] [&.capturing_[data-nocapture]]:hidden"
          ref={el}
        >
