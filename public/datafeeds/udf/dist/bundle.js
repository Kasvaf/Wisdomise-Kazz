!(function (e, s) {
        ...
        for (; this._limitedServerResponse && this._limitedServerResponse.maxResponseLength > 0 && this._limitedServerResponse.maxResponseLength === r && t.from < t.to; ) {
          ...
          (r = i.bars.length),
            'earliestFirst' === this._limitedServerResponse.expectedOrder
              ? (i.bars[0].time === e.bars[e.bars.length - 1].time && i.bars.shift(), e.bars.push(...i.bars))
              : (i.bars[i.bars.length - 1].time === e.bars[0].time && i.bars.pop(), e.bars.unshift(...i.bars));
        }
      } catch (e) {
        if (e instanceof Error || 'string' == typeof e) {
          const t = s(e);
    ...
    _processHistoryResponse(e) {
      ...
      if ('no_data' === e.s) (t.noData = !0), (t.nextTime = e.nextTime);
        ...
        for (let i = 0; i < e.t.length; ++i) {
          const o = { time: 1e3 * e.t[i], close: parseFloat(e.c[i]), open: parseFloat(e.c[i]), high: parseFloat(e.c[i]), low: parseFloat(e.c[i]) };
  ...
  class r {
    ...
    subscribeBars(e, s, t, r) {
      this._subscribers.hasOwnProperty(r) || ((this._subscribers[r] = { lastBarTime: null, listener: t, resolution: s, symbolInfo: e }), e.name);
    }
    unsubscribeBars(e) {
    ...
    _updateDataForSubscriber(e) {
      ...
      return this._historyProvider.getBars(s.symbolInfo, s.resolution, { from: r, to: t, countBack: 2, firstDataRequest: !1 }).then((s) => {
      ...
      return this._readyPromise.then(() => {
        ...
        const n = i
          ...
          .map((e) => {
            ...
            return { symbol: s.name, full_name: `${s.exchange}:${s.name}`, description: s.description, exchange: s.exchange, params: [], type: s.type, ticker: s.name };
          });
    ...
    _onExchangeDataReceived(e, s) {
      ...
      try {
        ...
        for (; t < e; ++t) {
          ...
          (void 0 === c && void 0 === h) || ((this._symbolsInfo[n(d, c, h)] = _), (this._symbolsInfo[n(e, c, h)] = _), (this._symbolsInfo[n(u, c, h)] = _)),
  ...
  class c {
      ...
      if (this._configuration.supports_group_request) {
        ...
        void 0 !== n && (t.unitId = n),
          this._send('symbols', t)
            .then((e) => {
              var s, t, i, o, n, l, u, c, h, d, _, m, p, b, y, g, f, v, P, q, w, S, x, k, R, I;
              if (void 0 !== e.s) r('unknown_symbol');
              else {
                const r = e.name,
                  U = null !== (s = e.listed_exchange) && void 0 !== s ? s : e['exchange-listed'],
                  B = null !== (t = e.exchange) && void 0 !== t ? t : e['exchange-traded'];
                a({
                  ...e,
                  name: r,
                  base_name: [U + ':' + r],
                  ...
                  exchange: B,
                  ticker: e.ticker,
                  currency_code: null !== (i = e.currency_code) && void 0 !== i ? i : e['currency-code'],
                  original_currency_code: null !== (o = e.original_currency_code) && void 0 !== o ? o : e['original-currency-code'],
                  unit_id: null !== (n = e.unit_id) && void 0 !== n ? n : e['unit-id'],
                  original_unit_id: null !== (l = e.original_unit_id) && void 0 !== l ? l : e['original-unit-id'],
                  unit_conversion_types: null !== (u = e.unit_conversion_types) && void 0 !== u ? u : e['unit-conversion-types'],
                  has_intraday: null !== (h = null !== (c = e.has_intraday) && void 0 !== c ? c : e['has-intraday']) && void 0 !== h && h,
                  visible_plots_set: null !== (d = e.visible_plots_set) && void 0 !== d ? d : e['visible-plots-set'],
                  minmov: null !== (m = null !== (_ = e.minmovement) && void 0 !== _ ? _ : e.minmov) && void 0 !== m ? m : 0,
                  minmove2: null !== (p = e.minmovement2) && void 0 !== p ? p : e.minmove2,
                  session: null !== (b = e.session) && void 0 !== b ? b : e['session-regular'],
                  session_holidays: null !== (y = e.session_holidays) && void 0 !== y ? y : e['session-holidays'],
                  supported_resolutions:
                    null !==
                    (v =
                      null !== (f = null !== (g = e.supported_resolutions) && void 0 !== g ? g : e['supported-resolutions']) && void 0 !== f
                        ? f
                        : this._configuration.supported_resolutions) && void 0 !== v
                      ? v
                      : [],
                  has_daily: null === (q = null !== (P = e.has_daily) && void 0 !== P ? P : e['has-daily']) || void 0 === q || q,
                  intraday_multipliers:
                    null !== (S = null !== (w = e.intraday_multipliers) && void 0 !== w ? w : e['intraday-multipliers']) && void 0 !== S ? S : ['1', '5', '15', '30', '60'],
                  has_weekly_and_monthly: null !== (x = e.has_weekly_and_monthly) && void 0 !== x ? x : e['has-weekly-and-monthly'],
                  has_empty_bars: null !== (k = e.has_empty_bars) && void 0 !== k ? k : e['has-empty-bars'],
                  volume_precision: null !== (R = e.volume_precision) && void 0 !== R ? R : e['volume-precision'],
    ...
    _setupWithConfiguration(e) {
      if (((this._configuration = e), void 0 === e.exchanges && (e.exchanges = []), !e.supports_search && !e.supports_group_request))
